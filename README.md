...
**Fast Recipe** is a Client-side mod that adds quick crafting in the recipe book. Press [Ctrl + LMB] on a recipe to craft it instantly.
...
### [See the original mod repository](https://github.com/ZipeStudio/fast-recipe)